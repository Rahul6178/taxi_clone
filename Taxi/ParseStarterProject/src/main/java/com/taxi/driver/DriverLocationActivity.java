...
public class DriverLocationActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void acceptRequest(View view) {
        ...
        ParseQuery<ParseObject> query = ParseQuery.getQuery("Call");
                            ...
                            object.saveInBackground(new SaveCallback() {
                                ...
                                public void done(ParseException e) {
                                    ...
                                    if (e == null) {
                                        ...
                                        directionsIntent.setPackage("com.google.android.apps.maps"); startActivity(directionsIntent);
...
//                                        startActivity(directionsIntent);
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
// ACTUALLY WE WERE NOT ABLE TO DRAG BUTTON IN MAP FRAGMENT THATS'S WHY WE HAVE TO CREATE THE RELATIVE LAYOUT
